...
describe('HttpStatusCode', () => {
  ...
  describe('2xx Success', () => {
    it('should have correct values', () => {
      ...
      expect(HttpStatusCode.NonAuthoritativeInformation).toBe(203);
      ...
      expect(HttpStatusCode.InstanceManipulationUsed).toBe(226);
    });
  });
  ...
  describe('4xx Client Errors', () => {
    it('should have correct values', () => {
      ...
      expect(HttpStatusCode.UriTooLong).toBe(414);
      expect(HttpStatusCode.UnsupportedMediaType).toBe(415);
      expect(HttpStatusCode.RangeNotSatisfiable).toBe(416);
      ...
      expect(HttpStatusCode.TooEarly).toBe(425);
  ...
  describe('5xx Server Errors', () => {
    it('should have correct values', () => {
      ...
      expect(HttpStatusCode.VariantAlsoNegotiates).toBe(506);
